...
namespace DatabaseAccess.Migrations
{
    ...
    [Migration("20240404032825_ResetMigrationTablePhase1")]
    partial class ResetMigrationTablePhase1
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Model.Room", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ROOM_ID = 1,
                            CREATED_DATE = new DateTime(2024, 4, 4, 16, 28, 25, 431, DateTimeKind.Local).AddTicks(6086),
                            ...
                            ROOM_PRICE = 85.0,
                            UPDATED_DATE = new DateTime(2024, 4, 4, 16, 28, 25, 431, DateTimeKind.Local).AddTicks(6087)
                        },
                        new
                        {
                            ROOM_ID = 2,
                            CREATED_DATE = new DateTime(2024, 4, 4, 16, 28, 25, 431, DateTimeKind.Local).AddTicks(6093),
                            DESCRIPTION = "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed finibus sed purus consequat porta. Praesent vitae tincidunt dolor, bibendum lacinia urna.",
                            IMAGE_URL = "https://placehold.co/600x400/png",
                            MAX_OCCUPANCY = 2,
                            ROOM_NAME = "Double Room",
                            ROOM_PRICE = 90.0,
                            UPDATED_DATE = new DateTime(2024, 4, 4, 16, 28, 25, 431, DateTimeKind.Local).AddTicks(6094)
                        },
                        new
                        {
                            ROOM_ID = 3,
                            CREATED_DATE = new DateTime(2024, 4, 4, 16, 28, 25, 431, DateTimeKind.Local).AddTicks(6100),
                            DESCRIPTION = "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed finibus sed purus consequat porta. Praesent vitae tincidunt dolor, bibendum lacinia urna.",
                            IMAGE_URL = "https://placehold.co/600x400/png",
                            MAX_OCCUPANCY = 3,
                            ROOM_NAME = "Deluxed Room",
                            ROOM_PRICE = 100.0,
                            UPDATED_DATE = new DateTime(2024, 4, 4, 16, 28, 25, 431, DateTimeKind.Local).AddTicks(6101)
                        },
                        new
                        {
                            ROOM_ID = 4,
                            CREATED_DATE = new DateTime(2024, 4, 4, 16, 28, 25, 431, DateTimeKind.Local).AddTicks(6107),
                            DESCRIPTION = "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed finibus sed purus consequat porta. Praesent vitae tincidunt dolor, bibendum lacinia urna.",
                            IMAGE_URL = "https://placehold.co/600x400/png",
                            MAX_OCCUPANCY = 4,
                            ROOM_NAME = "Queens Room",
                            ROOM_PRICE = 120.0,
                            UPDATED_DATE = new DateTime(2024, 4, 4, 16, 28, 25, 431, DateTimeKind.Local).AddTicks(6108)
                        },
                        new
                        {
                            ROOM_ID = 5,
                            CREATED_DATE = new DateTime(2024, 4, 4, 16, 28, 25, 431, DateTimeKind.Local).AddTicks(6114),
                            DESCRIPTION = "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed finibus sed purus consequat porta. Praesent vitae tincidunt dolor, bibendum lacinia urna.",
                            IMAGE_URL = "https://placehold.co/600x400/png",
                            MAX_OCCUPANCY = 5,
                            ROOM_NAME = "Kings Room",
                            ROOM_PRICE = 130.0,
                            UPDATED_DATE = new DateTime(2024, 4, 4, 16, 28, 25, 431, DateTimeKind.Local).AddTicks(6115)
                        },
                        new
                        {
                            ROOM_ID = 6,
                            CREATED_DATE = new DateTime(2024, 4, 4, 16, 28, 25, 431, DateTimeKind.Local).AddTicks(6120),
                            DESCRIPTION = "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed finibus sed purus consequat porta. Praesent vitae tincidunt dolor, bibendum lacinia urna.",
                            IMAGE_URL = "https://placehold.co/600x400/png",
                            MAX_OCCUPANCY = 10,
                            ROOM_NAME = "Executive Suite",
                            ROOM_PRICE = 180.0,
                            UPDATED_DATE = new DateTime(2024, 4, 4, 16, 28, 25, 431, DateTimeKind.Local).AddTicks(6121)
                        });
                });
