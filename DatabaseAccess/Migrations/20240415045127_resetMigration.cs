    ...
    public partial class resetMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2024, 4, 15, 16, 51, 27, 30, DateTimeKind.Local).AddTicks(270), "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed finibus sed purus consequat porta. Praesent vitae tincidunt dolor, bibendum lacinia urna.", "https://placehold.co/600x400/png", 1, "Single Room", 85.0, new DateTime(2024, 4, 15, 16, 51, 27, 30, DateTimeKind.Local).AddTicks(271) },
                    { 2, new DateTime(2024, 4, 15, 16, 51, 27, 30, DateTimeKind.Local).AddTicks(277), "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed finibus sed purus consequat porta. Praesent vitae tincidunt dolor, bibendum lacinia urna.", "https://placehold.co/600x400/png", 2, "Double Room", 90.0, new DateTime(2024, 4, 15, 16, 51, 27, 30, DateTimeKind.Local).AddTicks(278) },
                    { 3, new DateTime(2024, 4, 15, 16, 51, 27, 30, DateTimeKind.Local).AddTicks(284), "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed finibus sed purus consequat porta. Praesent vitae tincidunt dolor, bibendum lacinia urna.", "https://placehold.co/600x400/png", 3, "Deluxed Room", 100.0, new DateTime(2024, 4, 15, 16, 51, 27, 30, DateTimeKind.Local).AddTicks(285) },
                    { 4, new DateTime(2024, 4, 15, 16, 51, 27, 30, DateTimeKind.Local).AddTicks(291), "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed finibus sed purus consequat porta. Praesent vitae tincidunt dolor, bibendum lacinia urna.", "https://placehold.co/600x400/png", 4, "Queens Room", 120.0, new DateTime(2024, 4, 15, 16, 51, 27, 30, DateTimeKind.Local).AddTicks(292) },
                    { 5, new DateTime(2024, 4, 15, 16, 51, 27, 30, DateTimeKind.Local).AddTicks(298), "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed finibus sed purus consequat porta. Praesent vitae tincidunt dolor, bibendum lacinia urna.", "https://placehold.co/600x400/png", 5, "Kings Room", 130.0, new DateTime(2024, 4, 15, 16, 51, 27, 30, DateTimeKind.Local).AddTicks(299) },
                    { 6, new DateTime(2024, 4, 15, 16, 51, 27, 30, DateTimeKind.Local).AddTicks(305), "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed finibus sed purus consequat porta. Praesent vitae tincidunt dolor, bibendum lacinia urna.", "https://placehold.co/600x400/png", 10, "Executive Suite", 180.0, new DateTime(2024, 4, 15, 16, 51, 27, 30, DateTimeKind.Local).AddTicks(309) }
                });
