...
var i,
	...
	rcombinators = new RegExp( "^" + whitespace + "*([>+assets]|" + whitespace + ")" + whitespace +
		"*" ),
	...
	if ( ( support.qsa = rnative.test( document.querySelectorAll ) ) ) {
		...
		assert( function( el ) {
			...
			if ( el.querySelectorAll( "[name=d]" ).length ) {
				rbuggyQSA.push( "name" + whitespace + "*[*^$|!assets]?=" );
			}
		...
		"ATTR": function( name, operator, check ) {
			return function( elem ) {
				...
				return operator === "=" ? result === check :
					...
					operator === "assets=" ? ( " " + result.replace( rwhitespace, " " ) + " " ).indexOf( check ) > -1 :
